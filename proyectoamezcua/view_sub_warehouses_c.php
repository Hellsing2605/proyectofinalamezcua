...
<?php
$page_title = 'Ver Inventario de Sub-Almacén Cuadrillas';
...
if (isset($_GET['id'])) {
    ...
    $cuadrilla = find_by_id('cuadrillas', $cuadrilla_id);
    if (!$cuadrilla) {
        $session->msg("d", "ID de la cuadrilla no encontrado.");
        redirect('sub_warehouses.php');
    }

    $inventory = find_cuadrilla_inventory($cuadrilla_id);
    $returns = find_cuadrilla_returns($cuadrilla_id);
    $liquidations = find_cuadrilla_liquidations($cuadrilla_id);
        ...
        <div class="panel panel-default table-centered">
            <div class="panel-heading table-centered">
                <strong>
                    ...
                    <span>Inventario de <?php echo remove_junk($cuadrilla['name']); ?></span>
                </strong>
